...
git branch -M main
git remote add origin git@github.com:EIT-ALIVE/eitprocessing
```
...
and create a new repository named `eitprocessing` as an empty repository, then push your commits to GitHub:
...
automatically ([here](git@github.com:EIT-ALIVE/eitprocessing/issues?q=author%3Aapp%2Fgithub-actions)). Resolve them to complete the
